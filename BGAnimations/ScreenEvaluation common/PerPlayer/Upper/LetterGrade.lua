...
if SYNCMAN and SYNCMAN:IsEnabled() then
	...
	if GAMESTATE:IsCourseMode() then
		SYNCMAN:BroadcastFinalCourseScore(playerStats, ex_counts.W0, ex_counts.W1, ex_counts.W2, ex_counts.W3, ex_counts.W4, ex_counts.W5, ex_counts.Miss, ActualPoints, ActualPossible)
	else
		SYNCMAN:BroadcastFinalScore(playerStats, ex_counts.W0, ex_counts.W1, ex_counts.W2, ex_counts.W3, ex_counts.W4, ex_counts.W5, ex_counts.Miss, ActualPoints, ActualPossible)
	end
end
