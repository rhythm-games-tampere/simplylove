...
return Def.Actor{
	...
	JudgmentMessageCommand=function(self, params)
        ...
        if SYNCMAN and SYNCMAN:IsEnabled() then
            ...
            SYNCMAN:BroadcastScoreChange(stats, storage.ex_counts.W0, storage.ex_counts.W1, storage.ex_counts.W2, storage.ex_counts.W3, storage.ex_counts.W4, storage.ex_counts.W5, storage.ex_counts.Miss, ActualPoints, ActualPossible)
        end
